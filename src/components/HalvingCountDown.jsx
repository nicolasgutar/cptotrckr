        ...
        return (
            <div className="mt-8 bg-white shadow rounded p-6 w-full max-w-sm">
                <p className="text-center text-xl font-semibold">
                    {intl.formatMessage({ id: 'halving.complete', defaultMessage: 'The Bitcoin halving has occurred!' })}
                </p>
            </div>
        );
    }
    ...
    return (
        <div className="mt-8 bg-white shadow rounded p-6 w-full max-w-sm">
            <h2 className="text-xl font-semibold text-center">
                {intl.formatMessage({ id: 'halving.title', defaultMessage: 'Bitcoin Halving Countdown' })}
            </h2>
                ...
                {Object.keys(timeLeft).map((interval) => (
                    <div key={interval} className="text-center">
                        ...
                        <p className="text-gray-600">
                            {intl.formatMessage({ id: `halving.${interval.toLowerCase()}`, defaultMessage: interval })}
                        </p>
                    </div>
                ))}
            </div>
